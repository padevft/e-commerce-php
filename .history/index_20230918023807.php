      ...
      <div class="container-products">
        <div class="d-flex flex-column align-items-center justify-content-center gap-2">
          ...
          <span class="text-intro-2">
            Dans notre bibliothèque en ligne, vous trouverez une vaste collection de livres captivants, allant des classiques intemporels aux best-sellers contemporains. Plongez-vous dans des univers fantastiques, explorez des époques passées, et vivez des aventures palpitantes à travers les mots.
          </span>
        </div>
        <?php
