      ...
      <div class="container-products">
          ...
          <?php foreach ($products as $product) : ?>
            <div class="card position-relative item-product" style="width: 18rem;">
              ...
              <div class="hover-product">
                <span class="hover-product-1"><?php echo $product['text_1']; ?></span>
                <span class="hover-product-2"><?php echo $product['text_2']; ?></span>
              </div>
            </div>
          <?php endforeach; ?>
        </div> -->
        ...
        <div class="content-products">
          <div class="grid-products">
            <?php foreach ($products as $product) : ?>
              <div class="card position-relative item-product" style="width: 18rem;">
                <img src="client/images/p-1.webp" class="card-img-top" alt="...">
                <div class="card-body">
                  <h5 class="card-title title-product">Card title</h5>
                  <p class="card-text text-des"><?= get_sub_description($des); ?></p>
                  <div class="d-flex justify-content-center"><span class="text-price">$2500</span></div>
