            ...
            <div class="col-sm-8 col-md-9">
              <div class="container-header-product">
                <div class="d-flex justify-content-between align-items-center">
                  ...
                  <span class="fw-semibold">Trie par</span>
                  <div class="dropdown">
                    <span class="fw-semibold dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                    Trie par
                    </span>
                    <ul class="dropdown-menu">
                      <li><span class="dropdown-item">Nom</span></li>
                      <li><span class="dropdown-item">Prix</span></li>
                      <li><span class="dropdown-item">Pas de tri</span></li>
                    </ul>
                  </div>
                </div>
              </div>
