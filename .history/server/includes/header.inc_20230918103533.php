            ...
            <div class="col-12 col-sm-4">
                <div class="d-flex flex-row align-items-center">
                    <a class="container-logo" href="./index.html">
                        <img src="<?= getURL() ?>/shop-online/client/images/logo.png" />
            ...
            <div class="col-md-4">
                <div class="container-menu mt-2">
                    <ul class="d-flex flex-row align-items-center justify-content-end gap-4 menu">
                        <li><a href="<?= getURL() ?>/shop-online/index.php" class="menu-item">Accueil</a></li>
                        <li><a href="<?= getURL() ?>/shop-online/server/pages/shop.php" class="menu-item">Boutique</a></li>
                        <li><a href="<?= getURL() ?>/shop-online/server/pages/shop.php" class="menu-item">Contactez-nous</a></li>
                    </ul>
                </div>
            </div>
