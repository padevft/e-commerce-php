            ...
            <div class="col-12 col-sm-4">
                <div class="d-flex flex-row align-items-center">
                    <a class="container-logo" href="./index.html">
                        ...
                        <img src="http://<?php echo $_SERVER['SERVER_NAME']; ?>/shop-online/client/images/logo.png"/>
            ...
            <div class="col-md-4">
                <div class="container-menu mt-2">
                    <ul class="d-flex flex-row align-items-center justify-content-end gap-4 menu">
                        <li><a href="http://<?php echo $_SERVER['SERVER_NAME']; ?>/shop-online/index.php" class="menu-item">Accueil</a></li>
                        <li><a href="../../server/pages/shop.php" class="menu-item">Boutique</a></li>
                        <li><a href="../../server/pages/shop.php" class="menu-item">Contactez-nous</a></li>
                    </ul>
                </div>
            </div>
