    ...
    <main>
      ...
      <div class="container-products pt-5">
        <div class="d-flex flex-column align-items-center justify-content-center">
          ...
          <span class="text-intro-1">There are many variations of passages of Lorem Ipsum available, but the majority have suffered lebmid alteration in some ledmid form
          </span>
        </div>
      </div>
    </main>
