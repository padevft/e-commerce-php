              ...
              <div class="container-header-product">
                <div class="d-flex justify-content-between align-items-center">
                  ...
                  <div class="d-flex align-items-center justify-content-center gap-2">
                    ...
                    <div class="dropdown">
                      <span class="fw-semibold dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                        Tri par défaut
                      </span>
                      <ul class="dropdown-menu">
                        <li><span class="dropdown-item item-sorting">Nom</span></li>
                        <li><span class="dropdown-item item-sorting">Prix</span></li>
                        <li><span class="dropdown-item item-sorting">Tri par défaut</span></li>
                      </ul>
                    </div>
                  </div>
